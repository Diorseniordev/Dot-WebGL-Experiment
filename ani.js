...
function do_instructions9(){
 ...
 if (condition == 0){
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_-1_89_forward_padded.mp4"
  movieName="cones_30_deg_0_-1_89_forward_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_-1_89_forward_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_89_179_reverse_padded.mp4"
  ...
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_-1_89_reverse_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_89_179_forward_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_89_179_forward_padded.mp4"
  movieName="cones_30_deg_0_89_179_forward_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_89_179_forward_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_-1_89_reverse_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_89_179_reverse_padded.mp4"
  movieName="cones_30_deg_0_89_179_reverse_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_89_179_reverse_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_-1_89_forward_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_179_269_forward_padded.mp4"
  movieName="cones_30_deg_0_179_269_forward_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_179_269_forward_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_269_359_reverse_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_179_269_reverse_padded.mp4"
  movieName="cones_30_deg_0_179_269_reverse_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_179_269_reverse_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_269_359_forward_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_269_359_forward_padded.mp4"
  movieName="cones_30_deg_0_269_359_forward_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_269_359_forward_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_179_269_reverse_padded.mp4"
  ...
  document.querySelector("#final_video").src = "mp4/cones_30_deg_0_269_359_reverse_padded.mp4"
  movieName="cones_30_deg_0_269_359_reverse_padded.mp4"
  document.querySelector("#example1").src = "mp4/cones_30_deg_1_269_359_reverse_padded.mp4"
  document.querySelector("#example2").src = "mp4/cones_30_deg_1_179_269_forward_padded.mp4"
