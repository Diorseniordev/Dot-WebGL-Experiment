...
{
  $(instructions_id).html("<b>Informed Consent Form</b><br><br>" +
                          "<b>Questions:</b> If you have any questions about this study, you may contact Benjamin van Buren at benjamin.vanburen@yale.edu. <br><br>" +
                          ...
                          "Box 208010, New Haven, CT 06520-8010<br>" +
                          "(203) 785-4688; human.subjects@yale.edu<br>" +
...
function do_worker_id_used_error()
{
  ...
  $(instructions_id).html("<b>You have already completed this HIT!</b><br><br>" +
                          ...
                          "If you believe you have reached this message in error, please email the experimenter at benjamin.vanburen@yale.edu.<br><br>" +
...
age_val =        $("#age_selector").val();
  ...
  {
    pop("popDiv1")
    // alert('None of the values in the demographics form should be left empty! Please try again. If you prefer not to provide your race, ethnicity, or gender, please select "Prefer not to answer." If you believe you have reached this message in error, please email the experimenter at benjamin.vanburen@yale.edu.');
  }
  else
  {
...
function do_instructions6()
{
 ...
 if (condition == 0){
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_-1_89_forward_padded.mp4"
  movieName="cones_30_deg_0_-1_89_forward_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_-1_89_forward_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_89_179_reverse_padded.mp4"

  document.getElementById("example2").style.cssText = "-moz-transform: scale(-1, 1); \
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_-1_89_reverse_padded.mp4"
  movieName="cones_30_deg_0_-1_89_reverse_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_-1_89_reverse_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_89_179_forward_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_89_179_forward_padded.mp4"
  movieName="cones_30_deg_0_89_179_forward_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_89_179_forward_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_-1_89_reverse_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_89_179_reverse_padded.mp4"
  movieName="cones_30_deg_0_89_179_reverse_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_89_179_reverse_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_-1_89_forward_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_179_269_forward_padded.mp4"
  movieName="cones_30_deg_0_179_269_forward_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_179_269_forward_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_269_359_reverse_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_179_269_reverse_padded.mp4"
  movieName="cones_30_deg_0_179_269_reverse_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_179_269_reverse_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_269_359_forward_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_269_359_forward_padded.mp4"
  movieName="cones_30_deg_0_269_359_forward_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_269_359_forward_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_179_269_reverse_padded.mp4"
  ...
  document.getElementById("final_video").src = "mp4/cones_30_deg_0_269_359_reverse_padded.mp4"
  movieName="cones_30_deg_0_269_359_reverse_padded.mp4"
  document.getElementById("example1").src = "mp4/cones_30_deg_1_269_359_reverse_padded.mp4"
  document.getElementById("example2").src = "mp4/cones_30_deg_1_179_269_forward_padded.mp4"
  ...
  document.getElementById("example1").style.cssText = "-moz-transform: scale(-1, 1); \
  -webkit-transform: scale(-1, 1); -o-transform: scale(-1, 1); \
  transform: scale(-1, 1); filter: FlipH;";
  ...
  document.getElementById("final_video").style.cssText = "-moz-transform: scale(-1, 1); \
  -webkit-transform: scale(-1, 1); -o-transform: scale(-1, 1); \
  transform: scale(-1, 1); filter: FlipH;";
  document.getElementById("example1").style.cssText = "-moz-transform: scale(-1, 1); \
  -webkit-transform: scale(-1, 1); -o-transform: scale(-1, 1); \
  ...
  motion_toward_me = 0
  match_side = 0 //left
  overall_flip = 1 //the match and final video are flipped, and the decoy is not
  }
  ...
  console.log(document.getElementById("#example1").src)
  console.log(document.getElementById("#example2").src)
...
function do_worker_id_logging_error()
{
  ...
  $(instructions_id).html("<b>Error processing worker ID!</b><br><br>" +
                          ...
                          "Please close this window/tab and try reloading the HIT from the original link. If the problem occurs a second time, please email the experimenter at benjamin.vanburen@yale.edu.");
  set_object_center( instructions_id, 0, 0 );
}
...
function do_instructions8()
{
  ...
  if (win_width < $(instructions_bg_id).width() || win_height < $(instructions_bg_id).height()) //window too small
  {
    $(instructions_id).html("<b>Window too small!</b><br><br>" +
                            ...
                            "If you believe you have reached this message in error, please email the experimenter at benjamin.vanburen@yale.edu.");
    $(next_button_id).hide();
    $(back_button_id).hide();
    set_object_center( instructions_id, 0, 0 );
  }
...
function do_task()
{
  ...
  $("#instructions1").html("<b>Task</b><br><br>" +
                          "Please play both example videos below as many times as you need, until you feel familiar with them.  When you press 'Next', you will see a final test video.  You will then say whether the test video looked more like Example 1 or like Example 2.</b>");
  $("#instructions1").show();
  ...
  $(next_button_id).click(examplesViewed);
}
...
function examplesViewed() {
  ...
  if (viewedExample1 > 0 && viewedExample2 > 0){
    ...
    $("#example_container").hide()
    $("#instructions1").html("<b>Task</b><br><br>" +
                          "You will have only one chance to view the test animation.  Press play when you are ready.</b>");
    $("#final").show();
...
function gradeDebriefingQuestions() {
  ...
  if (dq2_text == "" || dq3_text == "" || dq4_text == "" || dq5_text == "" || dq6_text == ""){
    formIncomplete = 1;
  }
  ...
  if (formIncomplete >0){
    ...
    $.post( cgibin_dir + "ani_log_trial.py", {workerid:worker_id, gender:gender_val,age:age_val,win_resized:win_resize_trial_invalid, total_time:total_time_elapsed, condition, which_quarter,motion_toward_me,match_side,overall_flip,response,RT,movieName,admitted_switching_windows:switchedWindows,summarize_instructions:dq2_text,clear_enough:dq3_text,heard_of:dq4_text,display_problems:dq5_text,how_well:dq6_text,comp_code:completion_code});
