...
$(document).ready(function(){               
    ...
    var toggleMove = Math.round(Math.random());
    ...
    $('#marker').on('click', function(event){ // works!
        // if(toggleMove){toggleMove=-1}
        // else if(!toggleMove){toggleMove=1}

        if (toggleMove) {$('#marker').css({'background': 'red'});
        toggleMove = 0;
    }

      else if (!toggleMove) {$('#marker').css({'background': 'lime'});
        toggleMove = 1;
    }
